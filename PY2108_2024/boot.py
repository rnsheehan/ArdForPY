...
# "When the RX pin is connected to ground it will show up as a USB key, but if it is not grounded, it will not show up at all, while still being present for LabVIEW."
# FHP 4 - 10 - 2022
